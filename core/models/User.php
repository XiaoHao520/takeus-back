 ...
 * @property integer $is_photogrepher
 */
class User extends \yii\db\ActiveRecord implements IdentityInterface
{
    ...
    {
        return [
            [['type', 'addtime', 'is_delete', 'store_id', 'is_distributor', 'parent_id', 'time', 'is_clerk', 'we7_uid', 'shop_id', 'level', 'integral', 'total_integral','is_photographer'], 'integer'],
