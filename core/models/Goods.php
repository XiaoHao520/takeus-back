...
class Goods extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['store_id', 'name', 'original_price', 'detail', 'attr'], 'required'],
            [['store_id', 'cat_id', 'status', 'addtime', 'is_delete', 'sort', 'virtual_sales', 'individual_share', 'freight', 'use_attr', 'share_type', 'quick_purchase', 'hot_cakes', 'mch_id', 'goods_num', 'member_discount', 'mch_sort'], 'integer'],
