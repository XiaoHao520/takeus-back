...
class Topic extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            [['store_id'], 'required'],
            [['store_id', 'type', 'read_count', 'virtual_read_count', 'layout', 'sort', 'agree_count', 'virtual_agree_count', 'virtual_favorite_count', 'addtime', 'is_chosen', 'is_delete','target'], 'integer'],
