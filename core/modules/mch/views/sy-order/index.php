    ...
    <div class="panel-body">
                        ...
                        <div class="mr-4">
                            <div class="form-group">
                                ...
                                <a class="btn btn-secondary"
                                   href="<?= Yii::$app->request->url . "&flag=EXPORT" ?>" hidden>批量导出</a>
                            </div>
                        </div>
                    </div>
                    <div flex="dir:left">
        ...
        <div class="mb-4">
            <ul class="nav nav-tabs status">
                ...
                <li class="nav-item">
                    <a class="status-item nav-link <?= $status == 1 ? 'active' : null ?>"
                       href="<?= $urlManager->createUrl(array_merge([$_GET['r']], $condition, ['status' => 1])) ?>">待接单<?= $store_data['status_count']['status_1'] ? '(' . $store_data['status_count']['status_1'] . ')' : null ?></a>
                </li>
                <li class="nav-item">
                    <a class="status-item  nav-link <?= $status == 2 ? 'active' : null ?>"
                       href="<?= $urlManager->createUrl(array_merge([$_GET['r']], $condition, ['status' => 2])) ?>">服务中<?= $store_data['status_count']['status_2'] ? '(' . $store_data['status_count']['status_2'] . ')' : null ?></a>
                </li>
                <li class="nav-item">
                    <a class="status-item  nav-link <?= $status == 3 ? 'active' : null ?>"
                       href="<?= $urlManager->createUrl(array_merge([$_GET['r']], $condition, ['status' => 3])) ?>">可下载<?= $store_data['status_count']['status_3'] ? '(' . $store_data['status_count']['status_3'] . ')' : null ?></a>
                </li>
                <li class="nav-item">
                    <a class="status-item  nav-link <?= $status == 4 ? 'active' : null ?>"
                       href="<?= $urlManager->createUrl(array_merge([$_GET['r']], $condition, ['status' => 4])) ?>">已完成<?= $store_data['status_count']['status_6'] ? '(' . $store_data['status_count']['status_6'] . ')' : null ?></a>
                </li>
                <!--      <li class="nav-item">
        ...
        <table class="table table-bordered bg-white">
            <tr>
                ...
                <th class="order-tab-4">付款状态</th>
                <th class="order-tab-5">订单状态</th>
            </tr>
        </table>
            ...
            <div class="order-item" style="<?= $order_item['flag'] == 1 ? 'color:#ff4544' : '' ?>">
                ...
                <table class="table table-bordered bg-white">
                        ...
                        <td class="order-tab-1">
                            <div class="goods-item" flex="dir:left box:first">
                                ...
                                <div class="goods-info">
                                    <div class="goods-name"><?= $order_item['p_name'] ?></div>

                                    <div class="fs-sm">
                                        摄影师等级:<span class="text-danger"><?= $order_item['level_name'] ?></span>

                                    </div>
                                    <div class="fs-sm">
                                        需求类型:<span class="text-danger"><?= $order_item['r_name'] ?></span>

                                    </div>
                                    <div class="fs-sm">
                                        拍摄时间:<span class="text-danger"><?= $order_item['datetime'] ?></span>

                                    </div>
                                    <div class="fs-sm">
                                        拍摄地点:<span class="text-danger"><?= $order_item['address'] ?></span>
                    ...
                    <tr>
                        <td colspan="5">
                            <div>
                                <span class="mr-3">联系人：<?= $order_item['contact_name'] ?></span>
                                <span class="mr-3">联系电话：<?= $order_item['mobile'] ?></span>
                                <span>联系地址：<?= $order_item['contact_address'] ?></span>
                            </div>
