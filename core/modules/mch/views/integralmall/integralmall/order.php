                ...
                <table class="table table-bordered bg-white">
                    <tr>
                        <td colspan="5">
                            ...
                            <span class="mr-5">用户：<?= $order_item['user']['nickname'] ?></span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="order-tab-3">
                            ...
                            <div><?= $order_item['integral'] ?>积分</div>
                        </td>
                        ...
                        <td class="order-tab-5">
                            ...
                            <?php if ($_GET['is_recycle'] == 1): ?>
                                <a class="btn btn-sm btn-primary del" href="javascript:" hidden
                                   data-url="<?= $urlManager->createUrl(['mch/order/edit', 'order_id' => $order_item['id'], 'is_recycle' => 0]) ?>"
                                   data-content="是否移出回收站">移出回收站</a>
                            <?php else: ?>
                                <a class="btn btn-sm btn-danger del" href="javascript:" hidden
