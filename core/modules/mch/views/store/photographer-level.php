...
<div class="panel mb-3">
    <div class="panel-header">
        ...
        <ul class="nav nav-right">
            <li class="nav-item">
                <a class="nav-link" href="<?= $urlManager->createAbsoluteUrl(['mch/store/photographer-edit']) ?>">添加需求类型</a>
            </li>
        </ul>
    </div>
                ...
                <tr class="nav-item1">
                    ...
                    <td>
                        ...
                        <a class="btn btn-sm btn-primary"
                           href="<?= $urlManager->createUrl(['mch/store/photographer-edit', 'id' => $cat['id']]) ?>">修改</a>
