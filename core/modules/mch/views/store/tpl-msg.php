...
<div class="panel">
    ...
    <div class="panel-body">
        <form method="post" class="auto-form">
            ...
            <div class="form-group row">
                <div class="form-group-label col-sm-2 text-right">
                    <label class="col-form-label">摄影师接单消息id</label>
                </div>
                <div class="col-sm-6">
                    <input class="form-control" value="<?= $model->receive_tpl ?>" name="receive_tpl">
                    <div class="fs-sm text-muted">
                        <span>摄影师接单后向用户发送消息，</span>
                        <a href="javascript:" class="fs-sm" data-toggle="modal"
                           data-target="#receive_tpl">摄影师接单后通知模板消息id</a>
                    </div>
                </div>
            </div>
            <div class="form-group row">
                <div class="form-group-label col-sm-2 text-right">
                    <label class="col-form-label">摄影师新订单提醒</label>
                </div>
                <div class="col-sm-6">
                    <input class="form-control" value="<?= $model->new_order_tpl ?>" name="new_order_tpl">
                    <div class="fs-sm text-muted">
                        <span>摄影师新订单提醒，</span>
                        <a href="javascript:" class="fs-sm" data-toggle="modal"
                           data-target="#new_order_tpl">摄影师新订单提醒</a>
                    </div>
                </div>
            </div>
            <div class="form-group row">
                <div class="form-group-label col-sm-2 text-right">
                    <label class="col-form-label">摄影师增加服务费提醒</label>
                </div>
                <div class="col-sm-6">
                    <input class="form-control" value="<?= $model->add_service_tpl ?>" name="add_service_tpl">
                    <div class="fs-sm text-muted">
                        <span>摄影师增加服务费提醒，</span>
                        <a href="javascript:" class="fs-sm" data-toggle="modal"
                           data-target="#add_service_tpl">摄影师增加服务费提醒</a>
                    </div>
                </div>
            </div>
            <div class="form-group row">
                <div class="form-group-label col-sm-2 text-right">
                    <label class="col-form-label">客户支付服务费</label>
                </div>
                <div class="col-sm-6">
                    <input class="form-control" value="<?= $model->pay_service_tpl ?>" name="pay_service_tpl">
                    <div class="fs-sm text-muted">
                        <span>客户支付服务费，</span>
                        <a href="javascript:" class="fs-sm" data-toggle="modal"
                           data-target="#pay_service_tpl">客户支付服务费</a>
                    </div>
                </div>
            </div>
            <div class="form-group row">
                <div class="form-group-label col-sm-2 text-right">
                    <label class="col-form-label">摄影师订单完成消息</label>
                </div>
                <div class="col-sm-6">
                    <input class="form-control" value="<?= $model->order_finish_tpl ?>" name="order_finish_tpl">
                    <div class="fs-sm text-muted">
                        <span>摄影师订单完成消息，</span>
                        <a href="javascript:" class="fs-sm" data-toggle="modal"
                           data-target="#order_finish_tpl">摄影师订单完成消息</a>
                    </div>
                </div>
            </div>
            <div class="form-group row">
