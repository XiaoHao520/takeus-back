            ...
            <div class="form-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9">
                        ...
                        <div class="fs-sm text-muted"> 消费金额达到最低消费金额才可使用优惠券</div>
                    </div>
                </div>
                ...
                <div class="form-group row discount-type discount-type-2"
                    ...
                    <div class="col-9">
                        ...
                        <div class="text-danger text-muted">注：最多优惠到0.01元</div>
                    </div>
                </div>
                ...
                <div class="form-group row total-count"
                     style="<?= $model->is_join == null || $model->is_join == 1 ? 'display:none' : null ?>" hidden>
                    <div class="form-group-label col-3 text-right">
                ...
                <div class="coupon-type coupon-type-1" style="<?= $model->appoint_type != null && $model->appoint_type != 1 ? 'display:none' : null ?>" hidden>
                    <div class="form-group row">
                        <div class="form-group-label col-3 text-right">
