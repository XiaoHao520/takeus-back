...
<div class="panel mb-3" id="app">
    ...
    <div class="panel-body">
        <form class="auto-form" method="post" return="<?= $urlManager->createUrl(['mch/topic/index']) ?>">
            ...
            <div class="form-group row">
                <div class="form-group-label col-sm-2 text-right">
                    <label class="col-form-label">阅读对象</label>
                </div>
                <div class="col-sm-6">
                    <label class="radio-label">
                        <input value="0" <?= $model->target == 0 ? 'checked' : null ?> name="target" type="radio"
                               class="custom-control-input">
                        <span class="label-icon"></span>
                        <span class="label-text">所有用户</span>
                    </label>
                    <label class="radio-label">
                        <input value="1" <?= $model->target == 1 ? 'checked' : null ?> name="target" type="radio"
                               class="custom-control-input">
                        <span class="label-icon"></span>
                        <span class="label-text">摄影师</span>
                    </label>
                    <label class="radio-label">
                        <input value="1" <?= $model->target == 2 ? 'checked' : null ?> name="target" type="radio"
                               class="custom-control-input">
                        <span class="label-icon"></span>
                        <span class="label-text">普通用户</span>
                    </label>
                </div>
            </div>
