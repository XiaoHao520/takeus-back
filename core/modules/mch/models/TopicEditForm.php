...
class TopicEditForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            [['virtual_read_count', 'virtual_agree_count', 'virtual_favorite_count', 'layout', 'sort','target'], 'integer'],
            [['cover_pic', 'content'], 'string'],
            [['title', 'sub_title'], 'string', 'max' => 255],
            [['virtual_read_count', 'virtual_agree_count', 'virtual_favorite_count','target'], 'default', 'value' => 0],
