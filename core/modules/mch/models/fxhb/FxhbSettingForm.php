...
class FxhbSettingForm extends Model
{
    ...
    {
        $rs = [
            [['user_num', 'coupon_total_money', 'coupon_use_minimum', 'distribute_type', 'tpl_msg_id', 'game_time', 'coupon_expire', 'rule', 'share_title', 'share_pic',], 'trim',],
