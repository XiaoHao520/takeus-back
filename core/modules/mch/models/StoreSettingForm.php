...
class StoreSettingForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            [['show_customer_service', 'delivery_time', 'after_sale_time', 'cat_style', 'cut_thread', 'purchase_frame', 'is_recommend', 'recommend_count', 'cat_goods_cols', 'over_day', 'is_offline', 'is_coupon', 'cat_goods_count', 'send_type', 'nav_count', 'integral', 'dial'], 'integer'],
