...
//            ]);
        ...
        $list = $query->select('g.cover_pic goods_pic,or.id order_refund_id,o.id order_id,o.order_no,o.name,o.mobile,o.address,o.pay_type,u.nickname,u.id user_id,g.name goods_name,g.id goods_id,or.addtime,o.num,o.attr,o.total_price,or.type refund_type,or.status refund_status,or.desc refund_desc,or.pic_list refund_pic_list,or.refund_price,or.refuse_desc refund_refuse_desc')->asArray()->all();
