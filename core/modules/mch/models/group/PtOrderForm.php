...
//            ]);
        ...
        if ($this->flag == "EXPORT") {
            ...
            Export::order_2($list_ex, $offline, 2);
        }
        $count = $query->count();
    ...
    public function getGroupList()
    {
        ...
        foreach ($list as $key => $item) {
            ...
            $list[$key]['currentNum'] = PtOrder::find()
                ->andWhere(['is_delete' => 0, 'store_id' => $this->store_id, 'is_group' => 1])
                ->andWhere(['or', ['is_pay' => 1], ['pay_type' => 2]])
                ->andWhere(['OR', ['id' => $item['id']], ['parent_id' => $item['id']]])->count();
