...
class MchAddForm extends Model
{
    public $store_id;
    public $user_id;
    public $realname;
    ...
    {
        return [
            [['user_id', 'realname', 'tel', 'name', 'province_id', 'city_id', 'district_id', 'address', 'mch_common_cat_id', 'service_tel', 'logo', 'header_bg', 'transfer_rate', 'sort'], 'trim'],
