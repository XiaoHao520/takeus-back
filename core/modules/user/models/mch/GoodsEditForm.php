...
class GoodsEditForm extends Model
{
    ...
    public function save()
    {
        ...
        $this->model->attributes = $this->getAttributes(['name', 'unit', 'mch_sort', 'weight', 'cover_pic', 'price', 'original_price', 'service', 'freight', 'full_cut', 'use_attr', 'detail',]);
